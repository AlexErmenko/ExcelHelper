namespace ExcelApplication
{
	partial class Start
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.GetStart);
			// 
			// label1
			// 
			...
			this.label1.Text = "Тема: Створення багатофункціональної бібліотеки класів роботи таблицями MS Excel " +
    " на базі існуючої MS Excel";
			// 
			// Start
			// 
